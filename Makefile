...
OFILES = main.o text.o font.o drawImages.o menuBackground.o gameplayBackground.o gameOverBackground.o player.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = mylib.h text.h menuBackground.h gameplayBackground.h gameOverBackground.h player.h
